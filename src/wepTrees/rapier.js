export const BLOOD = {
  '1_1': {
    ...
    name: 'Tondo',
    type: 'major',
    img: `/skills/rapier_ability1_slash.webp`,
  ...
  '1_2': {
    ...
    type: 'minor',
    img: `/skills/rapier_bloodmasterpass2_heavybleeds.webp`,
  ...
  '1_4': {
    ...
    name: 'Engarde',
    type: 'minor',
    img: `/skills/rapier_bloodmasterpass3_redcurtains.webp`,
  ...
  '1_5': {
    ...
    name: 'Flurry',
    type: 'major',
    img: `/skills/rapier_ability2_flurry.webp`,
  ...
  '2_3': {
    ...
    type: 'major',
    img: `/skills/rapier_ability3_flourish.webp`,
  ...
  '2_5': {
    ...
    name: 'Overwhelm',
    type: 'minor',
    img: `/skills/rapier_ability2mod2_all_in.webp`,
  ...
  '3_3': {
    ...
    name: 'With Flair',
    type: 'minor',
    img: `/skills/rapier_ability3mod1_grit.webp`,
  ...
  '3_4': {
    ...
    name: 'Light Edge',
    type: 'minor',
    img: `/skills/rapier_bloodmasterpass5_doubleslash.webp`,
  ...
  '3_5': {
    ...
    type: 'minor',
    img: `/skills/rapier_ability2mod1_hastyflurry.webp`,
  ...
  '4_1': {
    ...
    name: 'And Again',
    type: 'minor',
    img: `/skills/rapier_ability1mod2_compoundattack.webp`,
  ...
  '4_3': {
    ...
    name: 'Swagger',
    type: 'minor',
    img: `/skills/rapier_ability3mod2_stamina.webp`,
  ...
  '4_5': {
    ...
    name: 'To the Bone',
    type: 'minor',
    img: `/skills/rapier_ability2mod3_continuedweakness.webp`,
  ...
  '5_1': {
    ...
    name: 'Proper Spacing',
    type: 'minor',
    img: `/skills/rapier_evasionpass2_controlledbreathing.webp`,
  ...
  '6_3': {
    ...
    name: 'Bloody End',
    type: 'ultimate',
    img: `/skills/rapier_ability3mod3_deadlyfinish.webp`,
...
export const GRACE = {
  ...
  '1_3': {
    ...
    name: 'Evade',
    type: 'major',
    img: `/skills/rapier_ability6_evade.webp`,
  ...
  '2_1': {
    ...
    name: 'Riposte',
    type: 'major',
    img: `/skills/rapier_ability4_riposte.webp`,
  ...
  '2_3': {
    ...
    name: 'Breathe In',
    type: 'minor',
    img: `/skills/rapier_ability6mod1_breath.webp`,
  ...
  '2_5': {
    ...
    name: 'Fleche',
    type: 'major',
    img: `/skills/rapier_ability5_aeriallunge.webp`,
  ...
  '3_5': {
    ...
    name: 'Quick Lunge',
    type: 'minor',
    img: `/skills/rapier_ability5mod1_renewedvigor.webp`,
  ...
  '4_3': {
    ...
    name: 'Adagio',
    type: 'minor',
    img: `/skills/rapier_ability6mod3_majortempo.webp`,
  ...
  '5_3': {
    ...
    name: 'Crescendo',
    type: 'minor',
    img: `/skills/rapier_ability6mod4_bursttempo.webp`,
  ...
  '5_5': {
    ...
    name: 'Interruption',
    type: 'minor',
    img: `/skills/rapier_ability5mod2_wake.webp`,
  ...
  '6_3': {
    ...
    name: 'Momentum',
    type: 'ultimate',
    img: `/skills/rapier_evasionpass3_momentum.webp`,
